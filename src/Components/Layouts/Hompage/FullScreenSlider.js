...
import slider4 from "../../../images/AIRCON copy.png";
// import slider3 from "../../../images/17.jpeg";
          ...
          <img src={slider4} />
           {/* <ul>
            ...
            >
              ...
              <div
                class="tp-caption tp-resizeme NotGeneric-Title"
                id="slide-82-layer-2"
              ...
              <div
                class="tp-caption tp-resizeme small_light_white "
                id="slide-82-layer-4"
                data-x="['center','center','center','center']"
                data-hoffset="['0','0','0','0']"
                data-y="['middle','middle','middle','middle']"
              ...
              >
                We deliver your products on time with pure safety. Sed ut perspiciatis unde
                <br /> omnis iste natus error sit voluptatem accusantium doloremque laudantium,
              </div>

             
              <div
                class="tp-caption tp-resizeme btn-theme bg-navy-blue rev-btn"
                id="slide-82-layer-5"
                data-x="['center','center','center','center']"
                data-hoffset="['0','0','0','0']"
                data-y="['middle','middle','middle','middle']"
            ...
            >
              ...
              >
                <span class="slider-small">Ready For Any</span> <br />
                Obstacle
              </div>
              ...
              <div
                ...
                data-splitout="none"
                data-responsive_offset="on"
                style={{zIndex: "2", whiteSpace: "nowrap", fontSize: "18px", lineHeight: "30px"}}
              >
                Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin,
                <br /> lorem quis bibendum auctor, nisi elit consequat ipsum, nec <br />
                sagittis sem nibh id elit.
              </div>

           
              <div
                class="tp-caption BigBold-Button rev-btn "
                id="slide-3-layer-3"
                data-x="left"
                data-hoffset="60"
                data-y="center"
                ...
                data-responsive_offset="on"
                data-responsive="off"
                style={{zIndex: "3", whiteSpace: "nowrap", fontWeight: "800",backgroundColor:"rgba(41, 46, 49, 1.00)",borderColor:"rgba(255, 255, 255, 0)",outline:"none",boxShadow:"none",boxSizing:"border-box"}}
              >
                READ MORE
              </div>
            </li>
